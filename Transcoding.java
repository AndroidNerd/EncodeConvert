...
public class Transcoding {
	...
	private String projectPath = "F:\\Company\\GitProject\\gitlab\\zhongchou_android";// 获取项目目录
	...
	public Transcoding() {
		...
		String temp_path = "D:/备份/fund" + proPath;
		tempPath = new File(temp_path);// 转码份区，可自行修改
		if (!tempPath.exists()) {
			tempPath.mkdirs();
		} else {
